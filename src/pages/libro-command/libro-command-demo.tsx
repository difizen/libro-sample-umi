...
export const LibroCommandDemo: React.FC = ()=>{
  ...
  const demoCommand1 = () => {
    ...
    commandRegistry.executeCommand(
      LibroDemoCommand['demoCommand1'].id,  
    );
  };
  ...
  const demoCommand2 = () => {
    ...
    commandRegistry.executeCommand(
      LibroDemoCommand['demoCommand2'].id,  
    );
  };
  ...
  return (
    <div className='libro-command-container'>
      <div className='libro-command-demo-panel'>
        ...
        <Button type='primary' onClick={()=>{libroCommandDemo.save(libroView)}} className='libro-command-demo-btn' ghost>保存文件</Button>
        <Button type='primary' onClick={()=>{libroCommandDemo.selectAll(libroView)}} className='libro-command-demo-btn' ghost>全选 Cell</Button>
        <Button type='primary' onClick={()=>{libroCommandDemo.runAllCells(libroView)}} className='libro-command-demo-btn' ghost>执行所有 Cell</Button>
        <Button type='primary' onClick={()=>{libroCommandDemo.insertCellBelow(libroView)}} className='libro-command-demo-btn' ghost>向下新增 Cell</Button>
        <div>自定义命令 Demo:</div>
        <Button type='primary' onClick={demoCommand1} className='libro-command-demo-btn'>自定义命令1</Button>
        <Button type='primary' onClick={demoCommand2} className='libro-command-demo-btn'>自定义命令2</Button>
      </div>
